...
Public Class Form1
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Initialization
        rootpathRetrobat.Text = My.Settings.PathRetrobato
        rootpathbatocera.Text = My.Settings.PathBatocerao
    ...
    Private Sub BrowseRetroBat_Click(sender As Object, e As EventArgs) Handles BrowseRetroBat.Click
        If FolderBrowserDialog1.ShowDialog() = DialogResult.OK Then
            My.Settings.PathRetrobato = FolderBrowserDialog1.SelectedPath.ToString
            My.Settings.Save()
    ...
    Private Sub Browsebatocera_Click(sender As Object, e As EventArgs) Handles Browsebatocera.Click
        If FolderBrowserDialog2.ShowDialog() = DialogResult.OK Then
            My.Settings.PathBatocerao = FolderBrowserDialog2.SelectedPath.ToString
            My.Settings.Save()
    ...
    Sub wherearethefiles()
        If rootpathbatocera.Text = "" Or rootpathRetrobat.Text = "" Then Exit Sub
